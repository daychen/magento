<?php
class Magestore_Groupdeal_Block_Adminhtml_Subscriber_Edit_Tab_Category
	extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
		return $this->getSubscriber()->getCategoryIds();
    }
	...
	{
		if(!$this->hasData('subscriber'))
		{
			$subscriber = Mage::getModel('groupdeal/subscriber')
						->load($this->getRequest()->getParam('id'));
			$this->setData('subscriber',$subscriber);
		}
